  ...
  return (
    <section id="faq" className="flex min-h-[80vh] md:min-h-[60vh] flex-col md:flex-row p-5 py-10 md:px-24 my-5">
      <div className="md:w-1/2 flex flex-col justify-center md:p-24 items-center md:items-start">
       ...
       <Link href="/contact">
        <button className="border w-fit flex my-5 items-center justify-between space-x-5 px-9 py-2 border-[#AEAEAE] hover:bg-[#c7c7c7] hover:text-black transition rounded-full">
          Connect With Us
        </button>
        </Link>
      </div>
