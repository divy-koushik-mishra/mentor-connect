const CtaSection = () => {
  ...
  return (
    <section className="bg-[#F0F0F0] px-5 py-10 flex flex-col space-y-10 items-center justify-center min-h-[80vh] md:py-24">
      ...
      <div className="md:w-3/4 w-full flex flex-col md:flex-row justify-center items-center space-y-5 md:space-y-0  md:space-x-5">
        <input
          type="text"
          className="md:w-1/2 px-10 py-3 md:py-5 rounded-full outline-none"
